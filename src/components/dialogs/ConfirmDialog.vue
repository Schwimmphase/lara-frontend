    ...
    >
        <v-card class="lara-card">
            <div class="ma-5">
                ...
                <LaraButton class="mt-2" type="primary" @click="close(true)"
                            id="confirm-dialogue-confirm-button">{{ $t('confirmDialog.confirm') }}</LaraButton>
                <LaraButton class="mt-4" type="secondary" @click="close(false)"
                            id="confirm-dialogue-cancel-button">{{ $t('confirmDialog.cancel') }}</LaraButton>
            </div>
